                                            ...
                                            <?php 
                                                ...
                                                $res2= mysqli_query($link, "select * from t_issuebook");
                                                 while ($row=mysqli_fetch_array($res)) {
                                                   ...
                                                   ?>
                                                        <ul>
                                                            <li><a style="color: #fff;" href="delete.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-undo-alt"></i></a></li>
                                                ...
                                                while ($row=mysqli_fetch_array($res2)) {
                                                   ...
                                                   ?>
                                                        <ul>
                                                            <li><a href="delete.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-undo-alt"></i></a></li>
                                                            <!-- <li><a href="delete.php?id=<?php echo $row["id"]; ?>"><i class="fas fa-trash"></i></a></li> -->
                                                        </ul> 
                                                    <?php 
                                                    echo "</td>";
